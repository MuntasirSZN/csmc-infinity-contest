...
<template>
  <div
    class="flex min-h-screen items-center justify-center bg-gradient-to-br from-cyan-50 to-blue-100 px-4 py-8 dark:from-neutral-900 dark:to-neutral-800"
  >
    <motion.div
    ...
    >
      <UCard class="shadow-2xl">
        <div class="text-center">
          ...
          <h2
            class="mb-4 text-3xl font-bold text-neutral-900 sm:text-2xl dark:text-neutral-100"
          >
